...
$result=$db->query("SELECT * FROM blog WHERE blog_title='".$blog_title."' AND blog_message='".$blog_message."'");
if($result->countRows()==0){
$result=$db->query("INSERT INTO blog (blog_id, user_id, blog_title, blog_message, root_id, blog_timestamp, blog_picture, blog_location) VALUES (NULL, '$user_id', '$blog_title', '$blog_message', '$root_id', '$date', '$imagename', '$blog_location')");
}
?>
<table>
<?
